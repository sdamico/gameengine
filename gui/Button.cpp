...
Button::Button(std::string ident, std::string contents, std::string texture, Vector p, Vector d, void (*callbk)(std::string))
{
...
void Button::render()
{
	...
	if(clicked)
	{
		...
		//clicked=false;
		if(SDL_GetTicks()-clickTimer>250)clicked=false;
	}
