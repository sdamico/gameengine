...
public:
	C3ds();
	C3ds(std::string id, std::string file, std::string shaderProgram, float scale);
	~C3ds();
	...
	bool intersect(C3ds *other, float scale, float otherScale, FVector separation, Quaternion q1, Quaternion q2);
