...
class Object
{
	...
	//texture *tex;
	Object();
	Object(std::string id, std::string model, Vector pos, Vector velocity, double mass, float scale);
	void build(std::string id, std::string model, Vector pos, Vector velocity, double mass, float scale);
	virtual ~Object();
